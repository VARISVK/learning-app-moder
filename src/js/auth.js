...
class AuthManager {
    ...
    async handleLogin() {
        ...
        try {
            const result = await window.electron.ipcRenderer.invoke('login-user', credentials);
    ...
    async handleRegister() {
        ...
        try {
            ...
            const result = await window.electron.ipcRenderer.invoke('register-user', userData);
